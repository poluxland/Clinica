...
class CentrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create centro" do
    assert_difference("Centro.count") do
      post centros_url, params: { centro: { area: @centro.area, comuna: @centro.comuna, modalidad: @centro.modalidad, nombre: @centro.nombre, otros: @centro.otros } }
    end
  ...
  test "should update centro" do
    patch centro_url(@centro), params: { centro: { area: @centro.area, comuna: @centro.comuna, modalidad: @centro.modalidad, nombre: @centro.nombre, otros: @centro.otros } }
